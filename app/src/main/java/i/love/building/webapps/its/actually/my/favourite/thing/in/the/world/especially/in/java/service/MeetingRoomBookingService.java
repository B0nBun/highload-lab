...
public class MeetingRoomBookingService {
    ...
    public MeetingRoomBooking create(MeetingRoom room, User user, Instant startTime, Instant endTime) throws MeetingRoomConflictException, BookingInPastException {
