...
public class BookingController {
    @Autowired
    WorkplaceBookingService workplaceBookings;

    @Autowired
    MeetingRoomBookingService meetingRoomBookings;
    ...
    public ResponseEntity<Void> deleteMeetingRoomBooking(
        @PathVariable @NotNull Long bookingId
    ) {
    ...
    public ResponseEntity<WorkplaceBookingDTO> createWorkplaceBooking(
        ...
        try {
            ...
            throw new ProblemResponseException(
                HttpStatus.CONFLICT,
                "user with id '%d' already has a workplace booking with date '%s' for workplace with id '%d'",
                e.getUserId(),
    ...
    public ResponseEntity<Void> deleteWorkplaceBooking(
        @PathVariable @NotNull Long bookingId
    ) {
