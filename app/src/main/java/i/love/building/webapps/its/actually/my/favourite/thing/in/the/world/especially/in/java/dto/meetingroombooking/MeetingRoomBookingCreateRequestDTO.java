...
class Validator implements ConstraintValidator<ValidatorAnnotation, MeetingRoomBookingCreateRequestDTO> {
    public void initialize(ValidatorAnnotation annotation) {}
    
    @Override
    public boolean isValid(MeetingRoomBookingCreateRequestDTO value, ConstraintValidatorContext context) {
