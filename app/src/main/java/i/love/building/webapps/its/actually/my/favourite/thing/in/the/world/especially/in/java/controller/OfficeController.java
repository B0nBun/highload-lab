...
public class OfficeController {
  ...
  public ResponseEntity<OfficeDetailedResponseDTO> getOffice(@NotNull @PathVariable Long officeId) {
    return this.offices
        ...
        .orElseThrow(
            () -> new ObjectNotFoundException("office with id '%d'", officeId).responseException());
  }
  ...
  public ResponseEntity<WorkplaceResponseDTO> createWorkplace(
      @NotNull @PathVariable Long officeId, @Valid @RequestBody WorkplaceCreateRequestDTO req) {
    try {
      Workplace workplace =
          this.offices.createWorkplace(officeId, req.monitors(), req.audioEquipment());
  ...
  public ResponseEntity<MeetingRoomResponseDTO> createMeetingRoom(
      @NotNull @PathVariable Long officeId, @Valid @RequestBody MeetingRoomCreateRequestDTO req) {
    try {
      MeetingRoom meetingRoom =
          this.offices.createMeetingRoom(officeId, req.remoteAvaialable(), req.capacity());
